...
# Step 1: Load and format the GWAS data from a gzipped file
gwas_file = '/Users/sanjeedahs/Desktop/NEWMR/CAD/GCST90132314.h.tsv.gz'
...
print("After selecting necessary columns:", df.shape)
print(df.head())
...
filtered_gwas_file = '/Users/sanjeedahs/Desktop/NEWMR/CAD/CAD.tsv'
